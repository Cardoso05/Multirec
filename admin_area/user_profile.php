...
<?php
    ...
    if (isset($_GET['user_profile'])) {
        ...
        $user_country = $row_user['admin_id'];
...
<body class="container">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="<?php echo $user_name; ?>" name="admin_name" class="form-control"
                                required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="<?php echo $user_email; ?>" name="admin_email"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" value="<?php echo $user_pass; ?>" name="admin_pass"
                                class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="<?php echo $user_country; ?>" name="admin_country"
                                class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="<?php echo $user_contact; ?>" name="admin_contact"
                                class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="<?php echo $user_job; ?>" name="admin_job" class="form-control"
                                required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="admin_about" class="form-control"
                                rows="3"><?php echo $user_about; ?></textarea>
    ...
    if (isset($_POST['update'])) {
        ...
        $update_user = "update admins set admin_name='$user_name',admin_pass='$user_pass',admin_country='$user_country',admin_contact='$user_contact',admin_job='$user_job',admin_about='$user_about',admin_image='$user_image' where admin_id='$user_id'";
